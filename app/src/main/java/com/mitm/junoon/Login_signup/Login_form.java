package com.mitm.junoon.Login_signup;
    ...
    private  void updateUItwo(FirebaseUser user)
    {
        ...
        if(user != null)
        {
          ...
          if(user.getPhotoUrl() != null)
          {
              ...
              loginButton =  findViewById(R.id.login_button);//ye khhud se likhe hn
              loginButton.setReadPermissions("email", "public_profile");//ye bhi
